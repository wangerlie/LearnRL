...
class Config(collections.Mapping):
    """
    A configuration class that wraps around a dictionary and provides additional functionality.

    Attributes:
        _class (type): The class to be instantiated with the configuration.
        _device (str, optional): The device to which the instance should be moved.
        _dict (dict): The dictionary holding the configuration key-value pairs.

    Methods:
        __init__(_class, verbose=True, savepath=None, device=None, **kwargs):
            Initializes the Config object with the given class and additional keyword arguments.
        
        __repr__():
            Returns a string representation of the Config object.
        
        __iter__():
            Returns an iterator over the configuration dictionary.
        ...
        __getattr__(attr):
            Returns the value associated with the given attribute name in the configuration dictionary.
        
        __call__(*args, **kwargs):
            Instantiates the class with the configuration and additional arguments, and moves it to the specified device if applicable.
    """
